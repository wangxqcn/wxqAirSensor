...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private TextView tv_data_Humi;
	private TextView tv_data_Light;
	private TextView tv_data_Co2;
	private TextView tv_extend_DeviceMac;
	private TextView tv_extend_DeviceHardVer;
	private TextView tv_extend_DeviceSoftVer;
	private TextView tv_extend_DeviceIp;
	...
	private void initView() {
		...
		tv_data_Humi = (TextView) findViewById(R.id.tv_data_Humi);
		tv_data_Light = (TextView) findViewById(R.id.tv_data_Light);
		tv_data_Co2 = (TextView) findViewById(R.id.tv_data_Co2);
		tv_extend_DeviceMac = (TextView) findViewById(R.id.tv_extend_DeviceMac);
		tv_extend_DeviceHardVer = (TextView) findViewById(R.id.tv_extend_DeviceHardVer);
		tv_extend_DeviceSoftVer = (TextView) findViewById(R.id.tv_extend_DeviceSoftVer);
		tv_extend_DeviceIp = (TextView) findViewById(R.id.tv_extend_DeviceIp);
	}
	...
	protected void updateUI() {
		...
		tv_data_Humi.setText(data_Humi+"");
		tv_data_Light.setText(data_Light+"");
		tv_data_Co2.setText(data_Co2+"");
		tv_extend_DeviceMac.setText(HexStrUtils.splitBytesString(HexStrUtils.bytesToHexString(data_DeviceMac)));
		tv_extend_DeviceHardVer.setText(HexStrUtils.splitBytesString(HexStrUtils.bytesToHexString(data_DeviceHardVer)));
		tv_extend_DeviceSoftVer.setText(HexStrUtils.splitBytesString(HexStrUtils.bytesToHexString(data_DeviceSoftVer)));
		tv_extend_DeviceIp.setText(HexStrUtils.splitBytesString(HexStrUtils.bytesToHexString(data_DeviceIp)));
